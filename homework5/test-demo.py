...
# Pytest ile testi çalıştırmak için terminaldeki komut : pytest test_saucedemo.py
...
# Pytest ile testi çalıştırmak için terminaldeki komut: pytest test_checkout.py